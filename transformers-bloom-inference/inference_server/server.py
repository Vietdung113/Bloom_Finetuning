...
class Args:
    def __init__(self) -> None:
        ...
        self.tokenise_name = os.getenv("TOKENISE_NAME", TOKENISE_DEFAULT)
        self.model_name = os.getenv("MODEL_NAME", TOKENISE_DEFAULT)
        self.model_class = os.getenv("MODEL_CLASS")
        self.dtype = get_torch_dtype(os.getenv("DTYPE"))
        self.allowed_max_new_tokens = int(os.getenv("ALLOWED_MAX_NEW_TOKENS", 512))
